...
namespace PurchasingSystemDeveloper.Migrations
{
    ...
    [Migration("20240731152341_updateUnitTransferAddQtySent")]
    partial class updateUnitTransferAddQtySent
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PurchasingSystemDeveloper.Areas.Warehouse.Models.UnitTransfer", b =>
                {
                    b.Property<Guid>("UnitTransferId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("UnitTransferNumber")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("WrhUnitTransfer", "dbo");
                });

            modelBuilder.Entity("PurchasingSystemDeveloper.Areas.Warehouse.Models.UnitTransferDetail", b =>
                {
                    b.Property<Guid>("UnitTransferDetaillId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasKey("UnitTransferDetaillId");

                    b.HasIndex("UnitTransferId");

                    b.ToTable("WrhUnitTransferDetail", "dbo");
                });
            ...
            modelBuilder.Entity("PurchasingSystemDeveloper.Areas.Warehouse.Models.UnitTransferDetail", b =>
                {
                    b.HasOne("PurchasingSystemDeveloper.Areas.Warehouse.Models.UnitTransfer", "UnitTransfer")
                        .WithMany("UnitTransferDetails")
                        .HasForeignKey("UnitTransferId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.Navigation("UnitTransfer");
                });
            ...
            modelBuilder.Entity("PurchasingSystemDeveloper.Areas.Warehouse.Models.UnitTransfer", b =>
                {
                    b.Navigation("UnitTransferDetails");
                });
